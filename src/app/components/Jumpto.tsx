...
export default function Jumpto({ albumData, onJumpToPhoto, selectedIndex }: { albumData: Photo[]; onJumpToPhoto: Function; selectedIndex: number | null }) {
  ...
  return (
    ...
    <div className="flex flex-row flex-wrap gap-2 ">
      {albumData.map((photo, index) => (
        ...
        index === selectedIndex ? "border-amber-400" : "border-blue-400"
